...
client.on("ready", () => {
    ...
    console.log("NDGAMERXbeta is ready join support server https://discord.gg/zFZQxDAPAh")
});



client.on("ready", () => {
  client.user.setActivity("NDGAMERX", { type: "STREAMING", url: "https://www.twitch.tv/ndgamerx" })
})

client.login("NTQ4Nzk4NzAzMjE4MTk2NTAw.XHESnw.j1gMGu_qc_TpPl0uu76JwhCblsk");